...
import id.sch.smktelkom_mlg.privateassignment.xirpl114.sammovie.adapter.NPAdapter;
...
public class NowPlayingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewtr = (RecyclerView) view.findViewById(R.id.recyclerViewtnpi);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try{
                            ...
                            adapter = new NPAdapter(listItems, getActivity().getApplicationContext());
                            //recyclerViewtr.addItemDecoration(new MaterialViewPagerHeaderDecorator());
